...
export const buyeoCutScreenText: Record<Locale, BuyeoCutScreenText> = {
  ko: {
    ...
    slotDragHintText: '사진을 위아래로 드래그해 위치를 맞춰보세요',
  ...
  en: {
    ...
    slotDragHintText: 'Drag a photo up or down to reframe it',
  ...
  ja: {
    ...
    slotDragHintText: '写真を上下にドラッグして位置を調整できます',
