...
type BuyeoCutScreenText = {
  ...
  slotDragHintText: string;
  aiGeneratedDisclaimerText: string;
  frameSectionLabel: string;
  frameOnLabel: string;
  frameNumberLabel: (index: number) => string;
...
export const buyeoCutScreenText: Record<Locale, BuyeoCutScreenText> = {
  ko: {
    ...
    slotDragHintText: '사진을 탭한 후, 드래그하거나 두 손가락으로 확대·축소해 위치를 맞춰보세요',
    aiGeneratedDisclaimerText: '*AI로 생성된 이미지 입니다.',
    frameSectionLabel: '프레임 선택',
    frameOnLabel: '프레임',
    frameNumberLabel: (index) => `프레임 ${index}`,
  ...
  en: {
    ...
    slotDragHintText: 'Tap a photo, then drag or pinch with two fingers to reframe it',
    aiGeneratedDisclaimerText: '*This image was generated by AI.',
    frameSectionLabel: 'Choose a Frame',
    frameOnLabel: 'Frame',
    frameNumberLabel: (index) => `Frame ${index}`,
  ...
  zh: {
    ...
    slotDragHintText: '点按照片后，拖动或用两指缩放来调整取景',
    aiGeneratedDisclaimerText: '*此图像由AI生成。',
    frameSectionLabel: '选择相框',
    frameOnLabel: '相框',
    frameNumberLabel: (index) => `相框 ${index}`,
    frameOffLabel: '无相框',
  ...
  ja: {
    ...
    slotDragHintText: '写真をタップしてから、ドラッグまたは2本指でズームして位置を調整できます',
    aiGeneratedDisclaimerText: '*この画像はAIによって生成されました。',
    frameSectionLabel: 'フレームを選ぶ',
    frameOnLabel: 'フレーム',
    frameNumberLabel: (index) => `フレーム${index}`,
...
type PersonCameraText = {
  ...
  poseNumberLabel: (index: number) => string;
...
export const personCameraText: Record<Locale, PersonCameraText> = {
  ko: {
    ...
    poseNumberLabel: (index) => `포즈 ${index}`,
  ...
  en: {
    ...
    poseNumberLabel: (index) => `Pose ${index}`,
  ...
  zh: {
    ...
    poseNumberLabel: (index) => `姿势 ${index}`,
  ...
  ja: {
    ...
    poseNumberLabel: (index) => `ポーズ${index}`,
