...
export const buyeoCutScreenText: Record<Locale, BuyeoCutScreenText> = {
  ko: {
    ...
    slotDragHintText: '사진을 드래그하거나 두 손가락으로 확대·축소해 위치를 맞춰보세요',
  ...
  en: {
    ...
    slotDragHintText: 'Drag, or pinch with two fingers to zoom, to reframe a photo',
  ...
  zh: {
    ...
    slotDragHintText: '拖动照片，或用两指缩放来调整取景',
  ...
  ja: {
    ...
    slotDragHintText: '写真をドラッグ、または2本指でズームして位置を調整できます',
